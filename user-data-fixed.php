...
// Construct SQL query with filters - use employees table directly now
...
<div class="app-card">
    <div class="card-header bg-primary">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <button type="button" id="exportCSV" class="btn btn-sm btn-light me-2" data-bs-toggle="tooltip"
                    title="Export to CSV">
                    <i class="fas fa-file-csv me-1"></i> Export
                </button>
                <button type="button" id="printList" class="btn btn-sm btn-light" data-bs-toggle="tooltip"
                    title="Print List">
            ...
            <table class="table table-hover app-table" id="employeeTable">
                ...
                try {
                    foreach ($pdo->query($sql) as $row) {
                        ...
                        // Now using rfid_uid directly from employees table for edit and delete operations
                        echo '<a href="user-data-edit-tb.php?id=' . $row['rfid_uid'] . '" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>';
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <p class="text-muted mb-0">
                    ...
                    Showing all
                    employees<?php if (!empty($departmentFilter)) echo ' in ' . htmlspecialchars($departmentFilter) . ' department'; ?>
